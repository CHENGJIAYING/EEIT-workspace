...
<head>
    ...
    <link href="${pageContext.request.contextPath}/all.min.css" rel="stylesheet" type="text/css">
    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="${pageContext.request.contextPath}/sb-admin-2.min.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables  -->
              <!--<li class="nav-item">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseOrders"
               ...
               <div id="collapseOrders" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">一般商品:</h6>
                        <a class="collapse-item  active" href="../Order/">一般訂單管理</a>
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">小農商品:</h6>
                        <a class="collapse-item" href="404.html">小農訂單管理</a>
                        <h6 class="collapse-header">課程:</h6>
                        <a class="collapse-item" href="404.html">課程訂單管理</a> 
                    </div>
                </div>
            </li>-->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                   ...
                   <p class="mb-4">
                   <a href="CreateOrder" class="btn btn-primary btn-icon-split btn-sm">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-cart-plus"></i>
                                        </span>
                                        <span class="text">建立訂單</span>
                                    </a>
            ...
            <td><a href="Details?orderId=${order.orderId}">
            ${order.orderNo}</a>
            </td>
            <td>${order.memNo}</td>
    		...
    		<fmt:formatDate pattern="yyyy/MM/dd HH:mm" value="${order.shipDate}" />
			</c:if>
            </td>
            <td>${order.totalPrice}</td>
            <td>${order.orderStatus}</td>
            <td>
            <a href="UpdateOrder?orderId=${order.orderId}" class="btn btn-warning btn-icon-split btn-sm">
                                        <span class="icon text-white-50">
         ...
         <td>
                                    ...
                                    <a href="DeleteOrder?orderId=${order.orderId}" class="btn btn-danger btn-icon-split btn-sm">
                                        <span class="icon text-white-50">
